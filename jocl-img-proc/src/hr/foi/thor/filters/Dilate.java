...
public class Dilate extends AbstractFilter {

    public static String kernelFileName = "src/hr/foi/thor/kernels/dilate.cl";
    public static String kernelName = "dilate";
        
    public Dilate(cl_context context, cl_device_id device){
	...
	public void applyFilter(BufferedImage inputImage) {
        ...
        try {
            File outputfile = new File("saved_d.png");
