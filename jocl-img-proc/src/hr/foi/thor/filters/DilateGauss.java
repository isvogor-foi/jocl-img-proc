...
public class DilateGauss extends AbstractFilter {

    public static String kernelFileName = "src/hr/foi/thor/kernels/dilate-gauss.cl";
    public static String kernelName = "dilate_gauss";
        
    public DilateGauss(cl_context context, cl_device_id device){
	...
	public void applyFilter(BufferedImage inputImage) {
        ...
        try {
            File outputfile = new File("saved-d-g.png");
