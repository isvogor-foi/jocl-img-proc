...
public class Sg extends AbstractFilter {

    public static String kernelFileName = "src/hr/foi/thor/kernels/sg.cl";
    public static String kernelName = "sobel_gauss";
        
    public Sg(cl_context context, cl_device_id device){
