...
public class Sge extends AbstractFilter{
	
    public static String kernelFileName = "src/hr/foi/thor/kernels/sge.cl";
    public static String kernelName = "sge";

    public Sge(cl_context context, cl_device_id device){
