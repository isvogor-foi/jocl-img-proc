...
public class Sged extends AbstractFilter{
	
    public static String kernelFileName = "src/hr/foi/thor/kernels/sged.cl";
    public static String kernelName = "sged";

    public Sged(cl_context context, cl_device_id device){
