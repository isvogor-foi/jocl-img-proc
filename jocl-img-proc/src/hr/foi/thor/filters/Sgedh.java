...
public class Sgedh extends AbstractFilter{
	
    public static String kernelFileName = "src/hr/foi/thor/kernels/sgedh.cl";
    public static String kernelName = "sgedh";

    public Sgedh(cl_context context, cl_device_id device){
